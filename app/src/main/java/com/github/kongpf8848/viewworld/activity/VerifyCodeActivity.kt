...
import com.github.kongpf8848.viewworld.databinding.ActivityVerifyCodeLineBinding
 ...
 * 验证码输入框
 */
class VerifyCodeActivity : BaseActivity<ActivityVerifyCodeLineBinding>() {

    override fun getLayoutId(): Int {
        return R.layout.activity_verify_code_line
    }
