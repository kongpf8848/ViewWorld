...
class MessageListSwipeCallback(
    ...
    override fun onChildDraw(
        ...
        Log.d("JACK8",
            "onChildDraw() called with: canvas = $canvas, recyclerView = $recyclerView, viewHolder = $viewHolder, dX = $dX, dY = $dY, actionState = $actionState, isCurrentlyActive = $isCurrentlyActive, success = $success"
        )
        if (dX != 0F) {
